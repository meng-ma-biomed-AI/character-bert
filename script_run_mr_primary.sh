...
hostname
scl enable rh-python36 'python /home/tpsanto/Github/character-bert/main.py --task classification --data_type mr --data_subtype primary --embedding medical_character_bert --do_lower_case --do_train --do_predict --train_batch_size=4 --eval_batch_size 16 --num_train_epochs 20 --gradient_accumulation_steps 4'
